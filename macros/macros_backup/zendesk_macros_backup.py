##Documentation: https://developer.zendesk.com/rest_api/docs/core/macros
...
if down in ["Y", "y"]:
    ...
    if os.name == 'nt':
        ...
        curl = "curl"
    os.system(curl + " https://camacuk.zendesk.com/api/v2/macros.json -v -u " + email + ":" + pword + " > data.json")
